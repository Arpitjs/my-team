...
router.get('/programs', authController.isLoggedIn, appController.upload)

router.get('/users', authController.protect, authController.restrictTo(), appController.getAllUsers)
router.post('/signUp', authController.signUp)
router.post('/login', authController.login)
router.patch('/updateMe', authController.protect, uploadController.uploadPhotos, uploadController.resizePhotos, uploadController.updateMe)
